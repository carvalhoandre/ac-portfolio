const FintechSVG = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="64"
      height="64" viewBox="0 0 32 32" className="icon-kaggle">
      <defs>
        <clipPath id="A">
          <use xlinkHref="#B" />
        </clipPath>
        <path fill="currentColor" stroke="currentColor" id="B" d="M31.5 15.978h289v130.044h-289z" />
      </defs>
      <path transform="matrix(.527027 0 0 .527027 -30.632288 -22.45559)" clipPath="url(#A)"
